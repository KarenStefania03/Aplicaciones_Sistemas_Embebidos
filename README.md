...
**B.Define la arquitectura Von Neumann y la Arquitectura de Harvar además: Exponer sus características ventajas y diferencias.**
		**RTA:**
		* Von Neumann, es una memraia que esta diseñada para datos e instrucciones
		* Harvar, es una memoria diseñada para poder separa datos e instrucciones lo cual nos permite mas velocidad
